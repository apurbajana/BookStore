...
const Navbar=()=> {
  ...
  return (
    <header className='w-fill bg-transparent fixed top-0 left-0 right-0 transition-all ease-in duration-300'>
        <nav className={`py-4 lg:px-24 px-4 ${isStickey? "stickey top-0 left-0 right-0 bg-blue-300":""}`}>
            ...
            {/*navItems sm devices*/}
            <div className={`space-y-4 px-4 mt-12 py-7m bg-blue-700 ${isMenuOpen ? "block fixed top-0 right-0 left-0":"hidden"}`}>
            {
